                            ...
                            {services.map((service) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className={`w-full rounded-3xl overflow-hidden transition-all duration-300 cursor-pointer border ${isActive ? 'bg-[#101828] text-white border-[#101828] p-8 md:p-12 shadow-xl' : 'bg-white text-[#101828] border-gray-100 p-8 md:p-10 hover:shadow-md'}`}
                                    >
                                        <div className="flex justify-between items-start gap-4">
                                            <div className="max-w-xl">
                                                ...
                                                <div className={`transition-all duration-300 overflow-hidden ${isActive ? "max-h-40 opacity-100 mt-4" : "max-h-0 opacity-0 mt-0"}`}>
